...
export const Icons = {
  ...
  AmazonLogo: ({ ...props }: LucideProps) => (
    <svg
      ...
      fill="#000000"
      version="1.1"
      viewBox="0 0 603 182" // Add the viewBox property here
    >
      <path
        fill="#f90"
