  ...
  return (
    <Sheet open={showCartPreview} onOpenChange={setShowCartPreview}>
      <SheetContent
        ...
        className="bg-background client md:rounded-none rounded-t-[20px]"
      >
        <SheetHeader>
          ...
          <div className=" relative h-[95%] flex flex-col justify-between">
            <div className="flex-fit overflow-scroll">
              <div className="p-4 flex flex-col gap-3">
                <div className="flex flex-col gap-3 w-full p-4 bg-theme-blue/10 items-center rounded-md">
                  <h1 className="font-bold text-xl text-theme-blue">Summary</h1>
            ...
            <div className="w-full grid grid-flow-cols  h-fit relative ">
              <Button
                size={"lg"}
